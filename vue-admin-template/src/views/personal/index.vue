<template>
    <div class="app-container">
      ...
      <el-form :inline=true>
        ...
        <el-button @click="AddItem" type="primary">上传失物</el-button>
      </el-form>
      ...
      <el-dialog :visible.sync="add_modalVisible" title="上传失物" @close="closeAddModal(false)">
        ...
        <p style="display: flex; align-items: center; margin-bottom: 15px;">
          ...
          <el-date-picker v-model="upload_item_time" type="date" value-format="yyyy-MM-dd" placeholder="请选择拾得时间..." style="flex: 1;" />
        </p>
        <p style="display: flex; align-items: center; margin-bottom: 15px;">
  ...
  export default {
    ...
    methods: {
      ...
      closeAddModal(confirmed){
        ...
        if(confirmed){
          ...
          .then(reponse=>{
            ...
            this.upload_user_contact_info=this.upload_user_Info.contact_info;
          })
          .catch(error=>{
      ...
      DeleteItem(id,name,category,claimed,claimed_user){
        ...
        this.delete_item_claimed_user=claimed_user?claimed_user:'无';
      },
